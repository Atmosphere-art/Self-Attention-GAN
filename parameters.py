...
def get_parameters():
    ...
    # Test images data path
    parser.add_argument('--test_path', type=str, default='./test_result')
    parser.add_argument('--test_data_path', type=str, default='D:/wrj/SeveralDatasets/Imagenet/val', help='Path to randomly read classes')

    # batch_size for test
    parser.add_argument('--batch_size_test', type=int, default=1)

    # Images data path & Output path
    parser.add_argument('--dataset', type=str, default='imagenet', choices=["cifar10", "fake", "folder", "hdf5", "imagenet", "lfw", "lsun"],
                        help="cifar10 | fake | folder | hdf5 | imagenet | lfw | lsun")
    # parser.add_argument('--datasets_prefix', type=str, default = '/root/paddlejob/workspace/train_data/datasets/')
    parser.add_argument('--data_path', type=str, default='D:/wrj/SeveralDatasets/Imagenet/img_train', help='Path to root of image data (saved in dirs of classes)')
    ...
    parser.add_argument('--max_frames_per_gif', type=int, default=5000)

    # Pretrained model
    parser.add_argument('--pretrained_model', type=str, default='E:/wrj/脚本/96117/output/ppoc_2293291_96117/weights/ckpt_2015000.pdparams')
    parser.add_argument('--state_dict_or_model', type=str, default='state_dict', help="Specify whether .pdparams pretrained_model is a 'state_dict' or a complete 'model'")

    # Misc
    parser.add_argument('--manual_seed', type=int, default=29)
    parser.add_argument('--disable_cuda', action='store_true', help='Disable CUDA')
    parser.add_argument('--parallel', type=int, default=1, help="Run on multiple GPUs")
